...
{
    if (!_titleArray) {
        _titleArray = @[@"01--简单工厂模式",@"02--策略模式",@"03--装饰模式",@"04--代理模式",@"05--工厂模式",@"06--原型模式",@"07--外观模式",@"08--建造者模式",@"09--抽象工厂模式",@"10--状态模式",@"11-适配器模式",@"12-备忘录模式",@"13-组合模式",@"14-单例模式",@"15-桥接模式"];
    }
    return _titleArray;
}
#pragma mark - 懒加载
